...
class MonsterData {
  static final List<Map<String, dynamic>> _monsterList = [
    ...
    {
      'name': '리자드맨 궁병',
      'imageName': 'lizardman_archer.gif',
      'startStage': 401,
      'endStage': 410,
      'def': 8,
    ...
    {
      'name': '리자드맨 검투사',
      'imageName': 'lizardman_gladiator.gif',
      'startStage': 421,
      'endStage': 430,
      'def': 8,
      'species': [MonsterSpecies.lizardman],
    ...
    {
      'name': '리자드맨 창병',
      'imageName': 'lizardman_spearman.gif',
      'startStage': 431,
      'endStage': 440,
      'def': 9,
      'species': [MonsterSpecies.lizardman],
    ...
    {
      'name': '변종 독버섯',
      'imageName': 'mutant_poison_mushroom.gif',
      'startStage': 491,
      'endStage': 499,
      'def': 10,
      'species': [MonsterSpecies.aberration],
    ...
    {
      'name': '신성국 경비병',
      'imageName': 'holy_kingdom_guard.gif',
      'startStage': 951,
      'endStage': 960,
      'def': 26,
    ...
    {
      'name': '신성국 경비대장',
      'imageName': 'holy_kingdom_captain.gif',
      'startStage': 961,
      'endStage': 970,
      'def': 26,
      'species': [MonsterSpecies.human, MonsterSpecies.holy],
    ...
    {
      'name': '신성국 기사',
      'imageName': 'holy_kingdom_knight.gif',
      'startStage': 971,
      'endStage': 980,
      'def': 26,
      'species': [MonsterSpecies.human, MonsterSpecies.holy],
    ...
    {
      'name': '신성국 기사단장',
      'imageName': 'holy_kingdom_knight_commander.gif',
      'startStage': 991,
      'endStage': 999,
      'def': 30,
      'species': [MonsterSpecies.human, MonsterSpecies.holy],
    ...
    {
      'name': '신성국 신자',
      'imageName': 'holy_kingdom_believer.gif',
      'startStage': 1001,
      'endStage': 1010,
      'def': 25,
      'species': [MonsterSpecies.human, MonsterSpecies.holy],
    ...
    {
      'name': '신성국 일등 신자',
      'imageName': 'holy_kingdom_first_believer.gif',
      'startStage': 1011,
      'endStage': 1020,
      'def': 25,
      'species': [MonsterSpecies.human, MonsterSpecies.holy],
    ...
    {
      'name': '신성국 전도사',
      'imageName': 'holy_kingdom_missionary.gif',
      'startStage': 1021,
      'endStage': 1030,
      'def': 25,
      'species': [MonsterSpecies.human, MonsterSpecies.holy],
    ...
    {
      'name': '신성국 주교',
      'imageName': 'holy_kingdom_bishop.gif',
      'startStage': 1031,
      'endStage': 1040,
      'def': 25,
      'species': [MonsterSpecies.human, MonsterSpecies.holy],
    ...
    {
      'name': '중급 천사',
      'imageName': 'intermediate_angel.gif',
      'startStage': 1061,
      'endStage': 1070,
      'def': 40,
      'species': [MonsterSpecies.angel, MonsterSpecies.holy],
    ...
    {
      'name': '세뇌된 아이',
      'imageName': 'brainwashed_child.gif',
      'startStage': 1101,
      'endStage': 1110,
      'def': 25,
      'species': [MonsterSpecies.human, MonsterSpecies.aberration],
    ...
    {
      'name': '세뇌된 청년',
      'imageName': 'brainwashed_youth.gif',
      'startStage': 1111,
      'endStage': 1120,
      'def': 25,
      'species': [MonsterSpecies.human, MonsterSpecies.aberration],
    ...
    {
      'name': '세뇌된 어른',
      'imageName': 'brainwashed_adult.gif',
      'startStage': 1141,
      'endStage': 1149,
      'def': 27,
      'species': [MonsterSpecies.human, MonsterSpecies.aberration],
    ...
    {
      'name': '거대 식인벌레',
      'imageName': 'giant_man_eating_bug.gif',
      'startStage': 1161,
      'endStage': 1170,
      'def': 35,
      'species': [MonsterSpecies.insect],
    ...
    {
      'name': '상태 안좋은 미라',
      'imageName': 'bad_condition_mummy.gif',
      'startStage': 1171,
      'endStage': 1180,
      'def': 35,
      'species': [MonsterSpecies.undead],
    ...
    {
      'name': '어인족 검사',
      'imageName': 'merman_swordsman.gif',
      'startStage': 1321,
      'endStage': 1330,
      'def': 41,
      'species': [MonsterSpecies.lizardman],
    ...
    {
      'name': '좀비 바퀴벌레',
      'imageName': 'zombie_cockroach.gif',
      'startStage': 1511,
      'endStage': 1520,
      'def': 48,
    ...
    {
      'name': '중급 악귀',
      'imageName': 'intermediate_fiend.gif',
      'startStage': 1671,
      'endStage': 1680,
      'def': 62,
      'species': [MonsterSpecies.demon],
    ...
    {
      'name': '중급 악마',
      'imageName': 'intermediate_demon.gif',
      'startStage': 1771,
      'endStage': 1780,
      'def': 66,
      'species': [MonsterSpecies.demon],
    ...
    {
      'name': '성체 그린 드래곤',
      'imageName': 'adult_green_dragon.gif',
      'startStage': 1901,
      'endStage': 1910,
      'def': 95,
      'species': [MonsterSpecies.dragon],
    ...
    {
      'name': '성체 화이트 드래곤',
      'imageName': 'adult_white_dragon.gif',
      'startStage': 1911,
      'endStage': 1920,
      'def': 95,
      'species': [MonsterSpecies.dragon],
    ...
    {
      'name': '새끼 수호룡',
      'imageName': 'young_guardian_dragon.gif',
      'startStage': 1951,
      'endStage': 1960,
      'def': 100,
      'species': [MonsterSpecies.dragon],
    ...
    {
      'name': '준성체 수호룡',
      'imageName': 'subadult_guardian_dragon.gif',
      'startStage': 1971,
      'endStage': 1980,
      'def': 100,
      'species': [MonsterSpecies.dragon],
    ...
    {
      'name': '성체 수호룡',
      'imageName': 'adult_guardian_dragon.gif',
      'startStage': 1981,
      'endStage': 1990,
      'def': 100,
      'species': [MonsterSpecies.dragon],
    ...
    {
      'name': '새끼 황금용',
      'imageName': 'young_gold_dragon.gif',
      'startStage': 1991,
      'endStage': 1999,
      'def': 110,
      'species': [MonsterSpecies.dragon],
